...
for i =1:num_Param
    min_sor_ras_fits(i,:)  = fullEGFR9_onemodel_fit_40_v2(my_other_params(i,:),min_sor_rastimedata,'min_sor_rastimedata', wanted_param);
    plus_sor_ras_fits(i,:) = fullEGFR9_onemodel_fit_40_v2(my_other_params(i,:),plus_sor_rastimedata,'plus_sor_rastimedata', wanted_param);
    min_sor_raf_fits(i,:)  = fullEGFR9_onemodel_fit_40_v2(my_other_params(i,:),min_sor_raftimedata,'min_sor_raftimedata', wanted_param);
    plus_sor_raf_fits(i,:) = fullEGFR9_onemodel_fit_40_v2(my_other_params(i,:),plus_sor_raftimedata,'plus_sor_raftimedata', wanted_param);
    min_sor_perk_fits(i,:) = fullEGFR9_onemodel_fit_40_v2(my_other_params(i,:),min_sor_perktimedata,'min_sor_perktimedata', wanted_param);
    min_sor_pmek_fits(i,:) = fullEGFR9_onemodel_fit_40_v2(my_other_params(i,:),min_sor_pmektimedata,'min_sor_pmektimedata', wanted_param);
end
